...
def parse_config():
    ...
    parser.add_argument('--load_in_4bit', action="store_true", default=False, help='weather use 4 bit to inference')
    ...
    parser.add_argument('--data_path', type=str, default="../../data/eval/pg19-validation.bin", help='')
