...
def parse_args():
    ...
    parser.add_argument('--adapter_name_or_path', type=str, default='')
    ...
    parser.add_argument('--eval_file', type=str, default="../../eval/data/pg19-validation.bin", help='')
    parser.add_argument('--load_in_4bit', type=bool, default=False, help='')
    parser.add_argument('--batch_size', type=int, default=32, help='batch size during inference')
    parser.add_argument('--max_seq_length', type=int, default=8092, help='context length during evaluation')
    parser.add_argument('--model_max_length', type=int, default=8092, help='context size during fine-tuning')
    parser.add_argument('--sliding_window', type=int, default=256, help='context size during fine-tuning')
...
def main():
    ...
    # 加载评测数据
    dataset = EvalDataset(args.eval_file, tokenizer, args.max_seq_length, args.sliding_window)
